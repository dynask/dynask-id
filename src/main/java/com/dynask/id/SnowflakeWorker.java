...
public class SnowflakeWorker {
    ...
    public SnowflakeWorker(long workerId, long dataCenterId, long startTime, long workerIdBits, long dataCenterIdBits, long sequenceBits) {
    ...
    public Id getId(long id){
        ...
        myId.setSequenceBits(sequenceBits);
        myId.setWorkerIdBits(workerIdBits);
        myId.setDataCenterId(dataCenterId);
        myId.setDataCenterIdBits(dataCenterIdBits);
        myId.setStartTime(startTime);
    ...
    public static void main(String[] args) {
         SnowflakeWorker idWorker = new SnowflakeWorker(1, 2);
